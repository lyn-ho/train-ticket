...
export const ACTION_SET_IS_CITY_ELECTOR_VISIBLE = 'SET_IS_CITY_ELECTOR_VISIBLE'
...
export function showCitySelector(currentSelectingLeftCity) {
  return (dispatch) => {
    dispatch({
      type: ACTION_SET_IS_CITY_ELECTOR_VISIBLE,
      payload: true,
    })
...
export function showDateSelector(from) {
  return {
...
export function hideDateSelector(from) {
  return {
    type: ACTION_SET_IS_DATE_SELECTOR_VISIBLE,
    payload: false,
  }
